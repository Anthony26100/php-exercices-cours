<?php
    ...
    if(isset($_POST['verifier'])){
        ...
        echo "<tr><th>&nbsp;CODE&nbsp;</th><th>&nbsp;ARTICLE&nbsp;</th><th class='total_prix'>&nbsp;PRIX&nbsp;</th></tr>";
            for($i=1;$i<count($tab_code);$i++){
                echo "<tr><td>&nbsp;".$tab_code[$i]."&nbsp;</td><td>&nbsp;".$tab_article[$i]."&nbsp;</td><td>&nbsp;".$tab_prix[$i]."&nbsp;</tdf></tr>";
                echo "<tr><td>&nbsp;$tab_code[$i]&nbsp;</td><td>&nbsp;$tab_article[$i]&nbsp;</td><td class='total_prix'>&nbsp;".sprintf('%01.2f €',$tab_prix[$i])."&nbsp;</tdf></tr>";
